...
public class INC extends AbstractMethod {
	private String key;
	private String arg2;
	
	
	public INC(IMKVSServer server, String protocol, String version, String key, String arg2) {
	...
	public boolean execute() {
		...
		boolean ret = server.increment(key);
