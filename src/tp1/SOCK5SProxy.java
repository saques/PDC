...
public class SOCK5SProxy implements Runnable{
	
	private ServerSocket serverSocket;
	private static final int DEFAULT_PORT = 1080;
	private static final int DEFAULT_BACKLOG = 50;
	private static final String LOCALHOST = "localhost";
	private List<Byte> supportedValidationMethods;
	private List<Byte> supportedCommands;
	
	private static final byte IPv4 = (byte)0x01;
	private static final byte DOMAINNAME = (byte)0x03;
	
	public SOCK5SProxy() throws UnknownHostException, IOException{
		this(DEFAULT_PORT,DEFAULT_BACKLOG,LOCALHOST);
	}
	
	public SOCK5SProxy(int port, int backlog, String bindAddr) throws UnknownHostException, IOException{
		this.serverSocket = new ServerSocket(port, backlog, InetAddress.getByName(bindAddr));
	...
	public static void main(String ... args) throws UnknownHostException, IOException{
		SOCK5SProxy sock5sProxy = new SOCK5SProxy();
		sock5sProxy.run();
	}
